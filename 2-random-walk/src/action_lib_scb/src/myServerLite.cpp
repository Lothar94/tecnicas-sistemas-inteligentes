...
protected:
  ...
  /*odometría se rellena con un callback de la subscripción.
  el server tiene asociado un objeto planner, es el que
...
public:
  ...
  as(n,"mi_move_base", boost::bind(&MyActionServer::ejecutaCB, this, _1), false),action_name(name){
    //Registra Callbacks.
